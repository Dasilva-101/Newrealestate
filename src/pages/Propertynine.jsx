...
function Propertynine(){
return(
    <div className="property-details-container">
      <ScroolToTop />
        <div className="bg-light py-4">
            <div className="container text-center"> 
                <h1>Parkview Estate Lagos</h1>
            </div>
        </div>
           <video width="800" height="1500" className="card-img-top" controls>
        ...
        <section className="py-5">
          <div className="container">
           <div className="row">
              <strong>Parkview Estate is a nicely built open-plan commercial complex. It is located at 99 Ajose Adeogun Street, Victoria Island, Lagos. The open-plan commercial complex comprises of 4 floors and a pent floor with a total lettable space of just above 2500sqm.</strong>
           </div>
