      ...
      <ScroolToTop />
        ...
        <div className="bg-light py-4">
            <div className="container text-center"> 
                <h1 className="text-dark">Ajah Lekki Lagos</h1>
            </div>
        </div>
        <div>
            <img src="./images/newhouse.jpg.jpg" alt="" className=" w-100" style={{height:'100vh',}}/>
        </div>
        <section className="py-5">
          <div className="container">
           <div className="row">
              <strong>This is a nicely built Duplex. It is located at Ajah Lekki, Lagos. The open-plan commercial complex comprises of 4 floors and a pent floor with a total lettable space of just above 2500sqm.</strong>
           </div>
