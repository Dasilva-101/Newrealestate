      ...
      <div className="property-details-container">
        ...
        <div className="bg-light py-4">
            <div className="container text-center"> 
                <h1 className="text-dark">Ikoyi Lagos</h1>
            </div>
        </div>
        <div className="w-100">
            <img src="./images/newhouse3.jpg" alt="" className=" w-100" style={{height:'80vh',}}/>
        </div>
        <section className="py-5">
          <div className="container">
           <div className="row">
              <strong>This is a nicely built Apartment. It is located at Ikoyi Lagos. The open-plan commercial complex comprises of 4 floors and a pent floor with a total lettable space of just above 2500sqm.</strong>
           </div>
