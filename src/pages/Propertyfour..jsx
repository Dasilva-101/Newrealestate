...
return(
    <div className="property-details-container">
      <ScroolToTop />
        ...
        <div className="w-100">
            <img src="./images/newhouse4.jpg" alt="" className=" w-100" style={{height:'80vh',}}/>
        </div>
        <section className="py-5">
          <div className="container">
           <div className="row">
              <strong>This is a nicely built Semi Detached House. It is located at Victoria Island, Lagos. The open-plan commercial complex comprises of 4 floors and a pent floor with a total lettable space of just above 2500sqm..</strong>
           </div>
